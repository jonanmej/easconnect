  ...
  SELECT jsonb_build_object(
    'trabajos_hoy', (
      ...
      WHERE estado <> 'cancelado'
        ...
        AND (fecha_programada + (GREATEST(COALESCE(duracion_dias,1),1) * interval '1 day')) > v_today_start
    ),
    ...
    'paneles_limpiados', (
      -- Ciclos completos: por cada trabajo de limpieza completado, contamos
      -- el parque total de paneles de esa planta.
      COALESCE((
      ...
      +
      -- Paneles reportados en trabajos de limpieza que aún están en curso.
      COALESCE((
