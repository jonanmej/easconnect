          ...
          <div key={s.id} className="p-4 flex flex-wrap gap-4 items-start">
            ...
            <div className="flex-1 min-w-[240px]">
              ...
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground mt-0.5">
                {s.cliente_nombre} · Fecha solicitada: {new Date(s.fecha_preferida + "T00:00").toLocaleDateString("es-CL", { day: "2-digit", month: "long" })} · Duración: {s.duracion_dias_estimada}d
              </p>
